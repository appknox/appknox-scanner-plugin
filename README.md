...
| `region`          | Specify the Appknox region. <br><br>Accepted values: 'Global, Saudi, UAE' <br><br>Default: 'Global' |
...
pipeline {
    ...
    parameters {
        ...
        choice(name: 'Region', choices: ['global', 'saudi', 'uae'], description: 'Appknox Regions')
    }
    stages {
        stage('Checkout') {
            steps {
